...
class ReservationController extends Controller
{
    ...
    public function updateStatus(Request $request, $id)
    {
        ...
        try {
            ...
            \Illuminate\Support\Facades\Log::error('Reservation WA Error: ' . $e->getMessage());
        }
    ...
    private function sendNotifications(Reservation $reservation): void
    {
        try {
            ...
            \Illuminate\Support\Facades\Log::error('Reservation WA Notification Error: ' . $e->getMessage());
        }
    }
}
