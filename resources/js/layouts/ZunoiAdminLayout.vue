                ...
                <nav class="mt-6 space-y-4 p-4">
                    ...
                    <div>
                        <button
                            ...
                            class="flex w-full items-center justify-between rounded-xl px-4 py-2 text-xs font-bold text-[#D4A373] uppercase tracking-wider hover:bg-[#FAEDCD]/5 transition"
                        >
                            <span v-if="isSidebarOpen">Analitik</span>
                                                        <svg v-else xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" class="w-5 h-5 mx-auto">
                                <path stroke-linecap="round" stroke-linejoin="round" d="M3 13.125C3 12.504 3.504 12 4.125 12h2.25c.621 0 1.125.504 1.125 1.125v6.75C7.5 20.496 6.996 21 6.375 21h-2.25A1.125 1.125 0 0 1 3 19.875v-6.75ZM9.75 8.625c0-.621.504-1.125 1.125-1.125h2.25c.621 0 1.125.504 1.125 1.125v11.25c0 .621-.504 1.125-1.125 1.125h-2.25a1.125 1.125 0 0 1-1.125-1.125V8.625ZM16.5 4.125c0-.621.504-1.125 1.125-1.125h2.25C20.496 3 21 3.504 21 4.125v15.75c0 .621-.504 1.125-1.125 1.125h-2.25a1.125 1.125 0 0 1-1.125-1.125V4.125Z" />
                            </svg>
                            <svg v-if="isSidebarOpen" :class="{'rotate-180': openMenus.analitik}" class="w-4 h-4 transition-transform duration-200" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7" /></svg>
                        </button>
                    ...
                    <div>
                        <button
                            ...
                            class="flex w-full items-center justify-between rounded-xl px-4 py-2 text-xs font-bold text-[#D4A373] uppercase tracking-wider hover:bg-[#FAEDCD]/5 transition"
                        >
                            <span v-if="isSidebarOpen">Transaksi & Penjualan</span>
                                                        <svg v-else xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" class="w-5 h-5 mx-auto">
                                <path stroke-linecap="round" stroke-linejoin="round" d="M2.25 18.75a60.07 60.07 0 0 1 15.797 2.101c.727.198 1.453-.342 1.453-1.096V4.22c0-.756-.728-1.296-1.453-1.096a59.769 59.769 0 0 1-15.797 2.101c-.727-.198-1.453.342-1.453 1.096v11.334c0 .756.728 1.296 1.453 1.096ZM12 9.75a3 3 0 1 0 0 6 3 3 0 0 0 0-6Z" />
                            </svg>
                            <svg v-if="isSidebarOpen" :class="{'rotate-180': openMenus.transaksi}" class="w-4 h-4 transition-transform duration-200" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7" /></svg>
                        </button>
                        
                        <div v-show="openMenus.transaksi" class="mt-1 space-y-1">
                            <Link
                    ...
                    <div>
                        ...
                        >
                            ...
                            <svg v-if="isSidebarOpen" :class="{'rotate-180': openMenus.operasional}" class="w-4 h-4 transition-transform duration-200" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7" /></svg>
                        </button>
                        
                        <div v-show="openMenus.operasional" class="mt-1 space-y-1">
                            <Link
                                :href="'/dashboard/menu'"
                                class="flex items-center gap-3 rounded-xl px-4 py-3 transition duration-200"
                                :class="
                    ...
                    <div>
                        ...
                        >
                            ...
                            <svg v-if="isSidebarOpen" :class="{'rotate-180': openMenus.sistem}" class="w-4 h-4 transition-transform duration-200" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7" /></svg>
                        </button>
