...
<template>
    ...
    <div
        class="flex min-h-screen items-center justify-center bg-gradient-to-br from-[#3B2314] via-[#4A2E1B] to-[#2A1A0E] p-4"
    >
        <div class="w-full max-w-2xl">
            <!-- Header -->
            <div class="mb-8 text-center">
                <div
                    class="mb-4 inline-flex h-20 w-20 items-center justify-center rounded-full bg-[#D4A373] shadow-xl"
                >
                    <span class="text-3xl font-black text-[#3B2314]">Z</span>
                </div>
                <h1 class="text-3xl font-black tracking-wider text-[#FAEDCD]">
                    ZUNOI CAFFE
                </h1>
                <p
                    class="mt-2 text-sm font-medium tracking-widest text-[#D4A373] uppercase"
                >
                    Reservasi Meja
                </p>
            </div>
            ...
            <!-- Form Card -->
            <div
                class="overflow-hidden rounded-3xl border border-[#D4A373]/20 bg-white/95 shadow-2xl backdrop-blur-xl"
            >
                <!-- Form Header -->
                <div class="bg-gradient-to-r from-[#3B2314] to-[#5A3E2A] p-6">
                    <h2
                        class="flex items-center gap-3 text-xl font-extrabold tracking-wide text-[#FAEDCD]"
                    >
                        <svg
                    ...
                    <p class="mt-1 text-xs text-white/60">
                        Isi form di bawah ini untuk memesan meja Anda.
                    </p>
                </div>
                ...
                <div class="space-y-5 p-6">
                    ...
                    <div>
                        ...
                        <input
                            ...
                            class="w-full rounded-xl border border-gray-300 px-4 py-3 text-sm transition focus:border-transparent focus:ring-2 focus:ring-[#D4A373] focus:outline-none"
                        />
                        <p
                    ...
                    <div class="grid grid-cols-1 gap-4 md:grid-cols-2">
                        ...
                        <div>
                            ...
                            <select
                                ...
                                class="w-full rounded-xl border border-gray-300 bg-white px-4 py-3 text-sm transition focus:border-transparent focus:ring-2 focus:ring-[#D4A373] focus:outline-none"
                            >
                            ...
                            <p
                                v-if="form.errors.reservation_time"
                                class="mt-1 text-xs text-red-500"
                            >
                    ...
                    <div>
                        ...
                        <div class="flex items-center gap-3">
                            <button
                                type="button"
                                @click="
                                    form.num_guests = Math.max(
                                        1,
                                        form.num_guests - 1,
                                    )
                                "
                                class="flex h-10 w-10 items-center justify-center rounded-xl bg-[#FAEDCD] text-lg font-bold text-[#3B2314] shadow-sm transition hover:bg-[#D4A373] hover:text-white"
                            >
                                −
                            </button>
                            <span
                                class="w-16 text-center text-2xl font-black text-[#3B2314]"
                                >{{ form.num_guests }}</span
                            >
                            <button
                                type="button"
                                @click="
                                    form.num_guests = Math.min(
                                        50,
                                        form.num_guests + 1,
                                    )
                                "
                    ...
                    <div>
                        ...
                        <textarea
                            ...
                            class="w-full resize-none rounded-xl border border-gray-300 px-4 py-3 text-sm transition focus:border-transparent focus:ring-2 focus:ring-[#D4A373] focus:outline-none"
                        ></textarea>
                    </div>
                            ...
                            <div class="flex items-center gap-2.5">
                                ...
                                <div class="text-left">
                                    ...
                                    <p class="text-[10px] text-gray-500">
                                        Pesan menu di muka agar siap saat Anda
                                        datang
                                    </p>
                                </div>
                            </div>
                            <svg
                                :class="{ 'rotate-180': showPreorder }"
                        ...
                        <div v-if="showPreorder" class="mt-4 space-y-4">
                            ...
                            <div class="relative">
                                <input
                                    ...
                                    class="w-full rounded-xl border border-gray-200 bg-gray-50 py-2.5 pr-4 pl-10 text-sm focus:ring-2 focus:ring-[#D4A373] focus:outline-none"
                                />
                                <svg
                                    xmlns="http://www.w3.org/2000/svg"
                                    fill="none"
                            ...
                            <!-- Menu Grid -->
                            <div
                                class="grid max-h-72 grid-cols-2 gap-3 overflow-y-auto pr-1 sm:grid-cols-3"
                            >
                                <button
                                    ...
                                    class="group rounded-xl border border-gray-200 bg-white p-3 text-left transition hover:border-[#D4A373] hover:shadow-md"
                                >
                                    <div
                                        class="mb-2 h-20 w-full overflow-hidden rounded-lg bg-[#FAEDCD]/30"
                                    >
                                        <img
                                            v-if="product.image"
                                            :src="product.image"
                                    ...
                                    <h4
                                        class="line-clamp-1 text-xs font-bold text-gray-800"
                                    >
                                        {{ product.name }}
                                    </h4>
                                    <p
                                        class="mt-0.5 text-[10px] font-bold text-[#D4A373]"
                                    >
                                    ...
                                    <div class="mt-1.5 flex justify-center">
                                        <span
                                            class="rounded-full bg-[#FAEDCD] px-3 py-1 text-[10px] font-bold text-[#3B2314] transition group-hover:bg-[#D4A373] group-hover:text-white"
                                            >+ Tambah</span
                                        >
                                    </div>
                                </button>
                            ...
                            >
                                ...
                                >
                                    ...
                                    >
                                        <div
                                            class="h-8 w-8 shrink-0 overflow-hidden rounded-lg bg-[#FAEDCD]/50"
                                        >
                                            <img
                                                v-if="item.image"
                                                :src="item.image"
                                    ...
                                    >
                                        ...
                                        >
                                            ...
                                            >
                                                <path
                                                    fill-rule="evenodd"
                                                    d="M8.75 1A2.75 2.75 0 0 0 6 3.75v.443c-.795.077-1.584.176-2.365.298a.75.75 0 1 0 .23 1.482l.149-.022 1.005 11.36A2.75 2.75 0 0 0 7.765 20h4.47a2.75 2.75 0 0 0 2.746-2.689l1.005-11.36.149.022a.75.75 0 0 0 .23-1.482A41.03 41.03 0 0 0 14 4.193V3.75A2.75 2.75 0 0 0 11.25 1h-2.5Z"
                                                    clip-rule="evenodd"
                                                />
                                            </svg>
                                        </button>
                    ...
                    <button
                        ...
                        "
                        class="flex w-full items-center justify-center gap-2 rounded-xl bg-gradient-to-r from-[#3B2314] to-[#5A3E2A] py-4 text-sm font-extrabold tracking-widest text-[#FAEDCD] uppercase shadow-lg transition-all duration-300 hover:from-[#D4A373] hover:to-[#C69C6D] hover:text-[#3B2314] disabled:cursor-not-allowed disabled:opacity-50"
                    >
                        <svg
                            v-if="isSubmitting"
            ...
            <!-- Footer -->
            <p
                class="mt-6 text-center text-xs tracking-wider text-[#D4A373]/60"
            >
                &copy; {{ new Date().getFullYear() }} Zunoi Caffe &mdash;
                Powered by Zunoi.id
            </p>
        </div>
    </div>
