...
<template>
    ...
    <div class="min-h-screen bg-[#3B2314]/5 md:bg-[#1E100A] md:bg-[url('https://images.unsplash.com/photo-1554118811-1e0d58224f24?q=80&w=1600')] md:bg-cover md:bg-center md:bg-blend-multiply flex items-center justify-center p-0 md:p-6 font-sans">
        ...
        <div class="w-full h-screen md:h-[88vh] md:max-h-[850px] md:max-w-md md:rounded-[44px] md:shadow-[0_30px_70px_rgba(0,0,0,0.8)] bg-[#FAEDCD] overflow-hidden md:border-[10px] md:border-[#3B2314] relative flex flex-col">
            ...
            <!-- Sticky Header -->
            <header class="bg-[#3B2314] text-[#FAEDCD] p-5 text-center shadow-md rounded-b-[28px] sticky top-0 z-40">
                <h1 class="text-base font-black tracking-widest uppercase">Zunoi Caffe</h1>
            </header>

            <!-- Scrollable Receipt Area -->
            <main class="flex-1 overflow-y-auto p-6 scrollbar-none space-y-5">
                
                <!-- Status Card -->
                <div class="bg-white p-5 rounded-[24px] shadow-sm border border-[#D4A373]/10 text-center relative overflow-hidden">
                ...
                <div class="bg-white p-6 rounded-[24px] shadow-sm border border-[#D4A373]/10 relative">
                ...
                <div v-if="order.payment_method === 'qris_tokopay'" class="bg-amber-50/50 text-[#3B2314] border border-[#D4A373]/20 p-4.5 rounded-[20px] text-[10px] font-black leading-relaxed flex items-start gap-2.5">
