            ...
            <form @submit.prevent="submitOrder" class="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8 items-start">
                ...
                <div class="space-y-6">
                    ...
                    <div class="bg-white p-5 rounded-2xl shadow-sm space-y-3 border border-[#D4A373]/10">
                        ...
                        <div class="bg-gray-50 p-1 rounded-xl flex gap-2 border border-[#D4A373]/5">
                            <button type="button" @click="form.order_type = 'dine_in'" :class="{'bg-[#3B2314] text-white border-[#3B2314]': form.order_type === 'dine_in', 'text-gray-500 bg-white border-gray-300': form.order_type !== 'dine_in'}" class="flex-1 py-2.5 rounded-lg font-bold text-xs transition-all duration-300 border shadow-sm">Dine In</button>
                            <button type="button" @click="form.order_type = 'takeaway'" :class="{'bg-[#3B2314] text-white border-[#3B2314]': form.order_type === 'takeaway', 'text-gray-500 bg-white border-gray-300': form.order_type !== 'takeaway'}" class="flex-1 py-2.5 rounded-lg font-bold text-xs transition-all duration-300 border shadow-sm">Takeaway</button>
                        </div>
                    </div>
                    ...
                    <div class="bg-white p-5 rounded-2xl shadow-sm space-y-4 border border-[#D4A373]/10">
                        ...
                        <div>
                            ...
                            <input v-model="form.customer_name" type="text" class="w-full text-xs rounded-xl border border-gray-300 shadow-sm focus:border-[#D4A373] focus:ring-1 focus:ring-[#D4A373] px-3 py-2" required>
                        </div>
                        <div>
                            <label class="block text-xs font-bold text-gray-600 mb-1">Nomor WhatsApp Aktif</label>
                            <input v-model="form.customer_phone" type="text" placeholder="Contoh: 08123456789" class="w-full text-xs rounded-xl border border-gray-300 shadow-sm focus:border-[#D4A373] focus:ring-1 focus:ring-[#D4A373] px-3 py-2" required>
