        ...
        <main class="flex-1 max-w-7xl w-full mx-auto px-4 sm:px-6 lg:px-8 py-8 pb-32">
            ...
            <div class="flex items-center gap-2 overflow-x-auto pb-4 mb-6 scrollbar-none -mx-4 px-4 sm:-mx-6 sm:px-6 lg:-mx-8 lg:px-8">
                ...
                <button 
                    ...
                    :class="{
                        'bg-[#3B2314] text-white shadow-md': selectedCategoryId === 'all',
                        'bg-white text-[#3B2314] border border-[#D4A373]/10 hover:bg-[#D4A373]': selectedCategoryId !== 'all'
                    }"
                    class="px-4 py-2 rounded-xl text-xs font-black tracking-wide whitespace-nowrap transition duration-200"
                >
                    Semua Menu
                </button>
                ...
                <button 
                    ...
                    :class="{
                        'bg-[#3B2314] text-white shadow-md': selectedCategoryId === cat.id,
                        'bg-white text-[#3B2314] border border-[#D4A373]/10 hover:bg-[#D4A373]': selectedCategoryId !== cat.id
                    }"
                    class="px-4 py-2 rounded-xl text-xs font-black tracking-wide whitespace-nowrap transition duration-200"
                >
                    {{ cat.name }}
